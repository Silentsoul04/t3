...
The web application is tricked into retrieving and rendering files hosted on a remote server. This can be used to execute arbitrary code on the server under the privileges of the web application.
